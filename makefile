...
$(WORKDIR.lib)/$(core_a):                   $(VTUNESDK.LIBS_A) $(CORE.tmpdir_a)/$(core_a:%.$a=%_link.$a) ; $(LINK.STATIC)
...
$(WORKDIR.lib)/$(core_y):                   $(daaldep.math_backend.ext_y) $(VTUNESDK.LIBS_A) \
...
$(WORKDIR.lib)/$(oneapi_y.dpc): LOPT += $(daaldep.math_backend.sycl_y)
