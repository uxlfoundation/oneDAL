...
dep_seq := $(if $(MSVC_RT_is_release),msvcrt.lib msvcprt.lib vcruntime.lib ucrt.lib, msvcrtd.lib msvcprtd.lib vcruntime.lib ucrtd.lib)
...
$(WORKDIR.lib)/$(oneapi_y.dpc): LOPT += $(mkl_flags)
