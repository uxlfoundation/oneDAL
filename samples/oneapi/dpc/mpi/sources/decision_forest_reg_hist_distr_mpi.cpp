...
void run(sycl::queue &queue) {
    const auto train_data_file_name = get_data_path("dev/data/df_regression_train_data.csv");
    const auto train_response_file_name = get_data_path("dev/data/df_regression_train_label.csv");
    const auto test_data_file_name = get_data_path("dev/data/df_regression_test_data.csv");
    const auto test_response_file_name = get_data_path("dev/data/df_regression_test_label.csv");
