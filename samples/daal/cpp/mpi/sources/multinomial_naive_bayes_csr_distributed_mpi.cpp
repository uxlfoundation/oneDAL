...
const std::string trainDatasetFileNames[4] = { "dev/data/naivebayes_train_csr.csv",
                                               "dev/data/naivebayes_train_csr.csv",
                                               "dev/data/naivebayes_train_csr.csv",
                                               "dev/data/naivebayes_train_csr.csv" };
...
std::string testdatasetFileName = "dev/data/naivebayes_test_csr.csv";
