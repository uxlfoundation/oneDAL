...
const std::string datasetFileNames[nBlocks] = { "dev/data/dbscan_dense_1.csv",
                                                "dev/data/dbscan_dense_2.csv",
                                                "dev/data/dbscan_dense_3.csv",
                                                "dev/data/dbscan_dense_4.csv" };
