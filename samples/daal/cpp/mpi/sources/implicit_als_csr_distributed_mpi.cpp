...
const std::string trainDatasetFileNames[nBlocks] = { "dev/data/implicit_als_trans_csr_1.csv",
                                                     "dev/data/implicit_als_trans_csr_2.csv",
                                                     "dev/data/implicit_als_trans_csr_3.csv",
                                                     "dev/data/implicit_als_trans_csr_4.csv" };
