...
template services::Status allValuesAreFiniteImpl<float, daal::internal::CpuType::DAAL_CPU>(NumericTable & table, bool allowNaN, bool * finiteness);
template services::Status allValuesAreFiniteImpl<double, daal::internal::CpuType::DAAL_CPU>(NumericTable & table, bool allowNaN, bool * finiteness);
