...
{
__DAAL_INSTANTIATE_DISPATCH_CONTAINER(low_order_moments::internal::BatchContainer, batch, DAAL_FPTYPE, low_order_moments::singlePassDense)
...
using BatchType = Batch<DAAL_FPTYPE, low_order_moments::singlePassDense>;
