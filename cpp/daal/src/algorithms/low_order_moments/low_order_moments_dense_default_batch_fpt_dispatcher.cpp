...
{
__DAAL_INSTANTIATE_DISPATCH_CONTAINER(low_order_moments::internal::BatchContainer, batch, DAAL_FPTYPE, low_order_moments::defaultDense)
namespace low_order_moments
{
namespace interface1
{
template <>
void Batch<DAAL_FPTYPE, low_order_moments::defaultDense>::initialize()
{
    this->_ac = new __DAAL_ALGORITHM_CONTAINER(batch, internal::BatchContainer, DAAL_FPTYPE, low_order_moments::defaultDense)(&_env);
}
template <>
