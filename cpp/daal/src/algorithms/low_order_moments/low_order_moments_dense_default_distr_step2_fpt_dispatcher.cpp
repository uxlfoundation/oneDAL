...
{
__DAAL_INSTANTIATE_DISPATCH_CONTAINER(low_order_moments::internal::DistributedContainer, distributed, step2Master, DAAL_FPTYPE, low_order_moments::defaultDense)
...
{
    Analysis<distributed>::_ac = new __DAAL_ALGORITHM_CONTAINER(distributed, internal::DistributedContainer, step2Master, DAAL_FPTYPE, low_order_moments::defaultDense)(&_env);
    _in                        = &input;
    _par                       = &parameter;
