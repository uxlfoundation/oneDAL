...
{
__DAAL_INSTANTIATE_DISPATCH_CONTAINER(low_order_moments::internal::OnlineContainer, online, DAAL_FPTYPE, low_order_moments::sumDense)
namespace low_order_moments
{
namespace interface1
{
template <>
void Online<DAAL_FPTYPE, low_order_moments::sumDense>::initialize()
{
    Analysis<online>::_ac = new __DAAL_ALGORITHM_CONTAINER(online, internal::OnlineContainer, DAAL_FPTYPE, low_order_moments::sumDense)(&_env);
    _in                   = &input;
    _par                  = &parameter;
