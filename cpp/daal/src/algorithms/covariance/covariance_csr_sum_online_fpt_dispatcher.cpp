...
{
__DAAL_INSTANTIATE_DISPATCH_CONTAINER(covariance::internal::OnlineContainer, online, DAAL_FPTYPE, covariance::sumCSR)
...
template <>
void OnlineType::initialize() { this->_ac = new __DAAL_ALGORITHM_CONTAINER(online, internal::OnlineContainer, DAAL_FPTYPE, covariance::sumCSR)(&_env); }
