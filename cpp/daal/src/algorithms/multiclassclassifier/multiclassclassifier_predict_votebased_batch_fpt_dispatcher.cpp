...
template <>
void Batch<DAAL_FPTYPE, multi_class_classifier::prediction::voteBased, multi_class_classifier::training::oneAgainstOne>::initialize()
{
    _in  = &input;
    _ac  = new __DAAL_ALGORITHM_CONTAINER(batch, internal::BatchContainer, DAAL_FPTYPE, multi_class_classifier::prediction::voteBased, multi_class_classifier::training::oneAgainstOne)(&_env);
    _par = &parameter;
