...
{
__DAAL_INSTANTIATE_DISPATCH_CONTAINER(multi_class_classifier::training::internal::BatchContainer, batch, DAAL_FPTYPE,
...
template <>
void Batch<DAAL_FPTYPE, multi_class_classifier::training::oneAgainstOne>::initialize()
{
    _ac  = new __DAAL_ALGORITHM_CONTAINER(batch, internal::BatchContainer, DAAL_FPTYPE, multi_class_classifier::training::oneAgainstOne)(&_env);
    _in  = &input;
    _par = &parameter;
