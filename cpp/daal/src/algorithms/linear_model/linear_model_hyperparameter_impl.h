/* file: linear_model_hyperparameter_impl.h */
/*******************************************************************************
...
//  of the linear model algorithm.
//--
*/

#ifndef LINEAR_MODEL_HYPERPARAMETER_IMPL
#define LINEAR_MODEL_HYPERPARAMETER_IMPL
...
/**
 * Available identifiers of integer hyperparameters of the linear model algorithm
 */
...
/**
 * \brief Hyperparameters of the linear model algorithm
 */
struct DAAL_EXPORT Hyperparameter : public daal::algorithms::Hyperparameter
{
    ...
    /**
     * Sets integer hyperparameter of the linear model algorithm
    ...
    /**
     * Finds integer hyperparameter of the linear model algorithm by its identifier
     * \param[in]  id       Identifier of the hyperparameter
