...
#include "services/daal_defines.h"
    ...
    #define __DAAL_INSTANTIATE_DISPATCH_IMPL(ContainerTemplate, Mode, ClassName, BaseClassName, GetCpuid, ...)                                       \
        ...
        {                                                                                                                                            \
        template <>                                                                                                                                  \
        ClassName<Mode, ContainerTemplate<__VA_ARGS__, daal::internal::sse42> DAAL_KERNEL_AVX2_CONTAINER(ContainerTemplate, __VA_ARGS__)                             \
        ...
        {                                                                                                                                            \
            ...
            default: _cntr = (new ContainerTemplate<__VA_ARGS__, daal::internal::sse42>(daalEnv)); break;                                                            \
            }                                                                                                                                        \
        }                                                                                                                                            \
                                                                                                                                                     \
        template class ClassName<Mode, ContainerTemplate<__VA_ARGS__, daal::internal::sse42> DAAL_KERNEL_AVX2_CONTAINER(ContainerTemplate, __VA_ARGS__)              \
