...
{
template <>
void Batch<DAAL_FPTYPE, svm::training::thunder>::initialize()
{
    _ac  = new __DAAL_ALGORITHM_CONTAINER(batch, internal::BatchContainer, DAAL_FPTYPE, svm::training::thunder)(&_env);
    _in  = &input;
    _par = &parameter;
