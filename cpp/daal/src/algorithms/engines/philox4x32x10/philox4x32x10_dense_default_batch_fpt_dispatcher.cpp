...
{
__DAAL_INSTANTIATE_DISPATCH_CONTAINER(engines::philox4x32x10::internal::BatchContainer, batch, DAAL_FPTYPE, engines::philox4x32x10::defaultDense)
namespace engines
{
...
{
    Analysis<batch>::_ac = new __DAAL_ALGORITHM_CONTAINER(batch, internal::BatchContainer, DAAL_FPTYPE, engines::philox4x32x10::defaultDense)(&_env);
    _in                  = &input;
