...
{
__DAAL_INSTANTIATE_DISPATCH_CONTAINER(implicit_als::training::init::internal::DistributedContainer, distributed, step1Local, DAAL_FPTYPE,
...
template <>
void Distributed<step1Local, DAAL_FPTYPE, implicit_als::training::init::fastCSR>::initialize()
{
    _ac  = new __DAAL_ALGORITHM_CONTAINER(distributed, internal::DistributedContainer, step2Local, DAAL_FPTYPE, implicit_als::training::init::fastCSR)(&_env);
    _in  = &input;
    _par = NULL;
