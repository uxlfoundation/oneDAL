...
{
__DAAL_INSTANTIATE_DISPATCH_CONTAINER(pca::internal::BatchContainer, batch, DAAL_FPTYPE, pca::svdDense)
namespace pca
{
namespace interface3
{
template <>
void Batch<DAAL_FPTYPE, pca::svdDense>::initialize()
{
    _ac  = new __DAAL_ALGORITHM_CONTAINER(batch, internal::BatchContainer, DAAL_FPTYPE, pca::svdDense)(&_env);
    _in  = &input;
    _par = &parameter;
