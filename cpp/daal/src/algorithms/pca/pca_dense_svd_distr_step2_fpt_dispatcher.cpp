...
{
__DAAL_INSTANTIATE_DISPATCH_CONTAINER(pca::internal::DistributedContainer, distributed, step2Master, DAAL_FPTYPE, pca::svdDense)
namespace pca
{
...
template <>
void Distributed<step2Master, DAAL_FPTYPE, pca::svdDense>::initialize()
{
