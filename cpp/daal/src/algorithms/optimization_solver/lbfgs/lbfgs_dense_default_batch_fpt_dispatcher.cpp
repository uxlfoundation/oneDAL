...
{
__DAAL_INSTANTIATE_DISPATCH_CONTAINER(optimization_solver::lbfgs::internal::BatchContainer, batch, DAAL_FPTYPE, optimization_solver::lbfgs::defaultDense)
...
{
    Analysis<batch>::_ac = new __DAAL_ALGORITHM_CONTAINER(batch, internal::BatchContainer, DAAL_FPTYPE, optimization_solver::lbfgs::defaultDense)(&_env);
    _par                 = &parameter;
    _in                  = &input;
