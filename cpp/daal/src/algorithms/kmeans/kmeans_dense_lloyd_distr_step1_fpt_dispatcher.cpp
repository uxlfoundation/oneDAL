...
{
__DAAL_INSTANTIATE_DISPATCH_CONTAINER(kmeans::internal::DistributedContainer, distributed, step1Local, DAAL_FPTYPE, kmeans::lloydDense);
...
template <>
void Distributed<step1Local, DAAL_FPTYPE, kmeans::lloydDense>::initialize()
{
