...
void DistributedType::initialize()
{
    Analysis<distributed>::_ac =
        new __DAAL_ALGORITHM_CONTAINER(distributed, internal::DistributedContainer, step3Master, DAAL_FPTYPE, kmeans::init::plusPlusDense)(&_env);
    _in = &input;
}
template <>
