...
{
__DAAL_INSTANTIATE_DISPATCH_CONTAINER(kmeans::init::internal::DistributedContainer, distributed, step3Master, DAAL_FPTYPE,
...
void Distributed<step3Master, DAAL_FPTYPE, kmeans::init::parallelPlusDense>::initialize()
{
    Analysis<distributed>::_ac =
        new __DAAL_ALGORITHM_CONTAINER(distributed, internal::DistributedContainer, step5Master, DAAL_FPTYPE, kmeans::init::parallelPlusDense)(&_env);
    _in = &input;
}
template <>
