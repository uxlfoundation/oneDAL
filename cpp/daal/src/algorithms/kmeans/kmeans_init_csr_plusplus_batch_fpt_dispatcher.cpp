...
{
__DAAL_INSTANTIATE_DISPATCH_CONTAINER(kmeans::init::internal::BatchContainer, batch, DAAL_FPTYPE, kmeans::init::plusPlusCSR)
...
template <>
void Batch<DAAL_FPTYPE, kmeans::init::plusPlusCSR>::initialize()
{
    Analysis<batch>::_ac = new __DAAL_ALGORITHM_CONTAINER(batch, internal::BatchContainer, DAAL_FPTYPE, kmeans::init::plusPlusCSR)(&_env);
    _in                  = &input;
}
template <>
