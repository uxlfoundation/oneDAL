...
{
__DAAL_INSTANTIATE_DISPATCH_CONTAINER(kmeans::init::internal::DistributedContainer, distributed, step2Master, DAAL_FPTYPE, kmeans::init::randomDense)
...
template <>
void Distributed<step2Master, DAAL_FPTYPE, kmeans::init::randomDense>::initialize()
{
    Analysis<distributed>::_ac = new __DAAL_ALGORITHM_CONTAINER(distributed, internal::DistributedContainer, step5Master, DAAL_FPTYPE, kmeans::init::randomDense)(&_env);
    _in                        = &input;
}
template <>
