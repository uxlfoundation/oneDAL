...
{
__DAAL_INSTANTIATE_DISPATCH_CONTAINER(kmeans::internal::BatchContainer, batch, DAAL_FPTYPE, kmeans::lloydCSR)
...
template <>
void Batch<DAAL_FPTYPE, kmeans::lloydCSR>::initialize()
{
    Analysis<batch>::_ac = new __DAAL_ALGORITHM_CONTAINER(batch, internal::BatchContainer, DAAL_FPTYPE, kmeans::lloydCSR)(&_env);
    _in                  = &input;
}
template <>
