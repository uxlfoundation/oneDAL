...
{
__DAAL_INSTANTIATE_DISPATCH_CONTAINER(kmeans::internal::DistributedContainer, distributed, step1Local, DAAL_FPTYPE, kmeans::lloydCSR)
...
template <>
void Distributed<step1Local, DAAL_FPTYPE, kmeans::lloydCSR>::initialize()
{
    Analysis<distributed>::_ac = new __DAAL_ALGORITHM_CONTAINER(distributed, internal::DistributedContainer, step5Master, DAAL_FPTYPE, kmeans::lloydCSR)(&_env);
    _in                        = &input;
}
template <>
