...
{
__DAAL_INSTANTIATE_DISPATCH_CONTAINER(dbscan::internal::DistributedContainer, distributed, step3Local, DAAL_FPTYPE, dbscan::defaultDense)
...
template <>
void Distributed<step3Local, DAAL_FPTYPE, dbscan::defaultDense>::initialize()
{
