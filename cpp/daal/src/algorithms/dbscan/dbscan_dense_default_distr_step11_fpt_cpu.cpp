/* file: dbscan_dense_default_distr_step11_fpt_cpu.cpp */
/*******************************************************************************
...
namespace internal
{
template class DistributedContainer<step11Local, DAAL_FPTYPE, defaultDense, DAAL_CPU>;

template class DBSCANDistrStep11Kernel<DAAL_FPTYPE, defaultDense, DAAL_CPU>;
} // namespace internal
} // namespace dbscan
} // namespace algorithms
} // namespace daal
