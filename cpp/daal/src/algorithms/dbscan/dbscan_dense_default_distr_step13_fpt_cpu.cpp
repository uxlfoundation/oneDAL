/* file: dbscan_dense_default_distr_step13_fpt_cpu.cpp */
/*******************************************************************************
...
namespace internal
{
template class DistributedContainer<step13Local, DAAL_FPTYPE, defaultDense, DAAL_CPU>;

template class DBSCANDistrStep13Kernel<DAAL_FPTYPE, defaultDense, DAAL_CPU>;
} // namespace internal
} // namespace dbscan
} // namespace algorithms
} // namespace daal
