...
{
__DAAL_INSTANTIATE_DISPATCH_CONTAINER(dbscan::internal::DistributedContainer, distributed, step10Local, DAAL_FPTYPE, dbscan::defaultDense)
...
template <>
void Distributed<step10Local, DAAL_FPTYPE, dbscan::defaultDense>::initialize()
{
