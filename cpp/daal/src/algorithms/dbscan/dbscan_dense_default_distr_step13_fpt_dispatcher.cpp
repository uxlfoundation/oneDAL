...
{
__DAAL_INSTANTIATE_DISPATCH_CONTAINER(dbscan::internal::DistributedContainer, distributed, step13Local, DAAL_FPTYPE, dbscan::defaultDense)
...
template <>
void Distributed<step13Local, DAAL_FPTYPE, dbscan::defaultDense>::initialize()
{
