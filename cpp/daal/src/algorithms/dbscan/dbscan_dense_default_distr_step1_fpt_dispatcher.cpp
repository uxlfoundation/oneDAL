...
{
__DAAL_INSTANTIATE_DISPATCH_CONTAINER(dbscan::internal::DistributedContainer, distributed, step1Local, DAAL_FPTYPE, dbscan::defaultDense)
...
template <>
void Distributed<step1Local, DAAL_FPTYPE, dbscan::defaultDense>::initialize()
{
