/* file: dbscan_dense_default_distr_step12_fpt_cpu.cpp */
/*******************************************************************************
...
namespace internal
{
template class DistributedContainer<step12Local, DAAL_FPTYPE, defaultDense, DAAL_CPU>;

template class DBSCANDistrStep12Kernel<DAAL_FPTYPE, defaultDense, DAAL_CPU>;
} // namespace internal
} // namespace dbscan
} // namespace algorithms
} // namespace daal
