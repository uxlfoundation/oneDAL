...
{
__DAAL_INSTANTIATE_DISPATCH_CONTAINER(svd::internal::DistributedContainer, distributed, step3Local, DAAL_FPTYPE, svd::defaultDense)
namespace svd
{
...
template <>
void Distributed<step3Local, DAAL_FPTYPE, svd::defaultDense>::initialize()
{
    Analysis<distributed>::_ac = new __DAAL_ALGORITHM_CONTAINER(distributed, internal::DistributedContainer, step3Local, DAAL_FPTYPE, svd::defaultDense)(&_env);
    _in                        = &input;
    _par                       = &parameter;
}
template <>
