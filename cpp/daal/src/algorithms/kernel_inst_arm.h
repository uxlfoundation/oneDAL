...
#include "services/daal_defines.h"
    ...
    #define __DAAL_INSTANTIATE_DISPATCH_IMPL(ContainerTemplate, Mode, ClassName, BaseClassName, GetCpuid, ...)                                     \
        ...
        {                                                                                                                                          \
        template <>                                                                                                                                \
        ClassName<Mode, ContainerTemplate<__VA_ARGS__, daal::internal::sve> DAAL_KERNEL_SVE_CONTAINER(ContainerTemplate, __VA_ARGS__)>::ClassName( \
        ...
        {                                                                                                                                          \
            ...
            default: _cntr = (new ContainerTemplate<__VA_ARGS__, daal::internal::sve>(daalEnv)); break;                                            \
            }                                                                                                                                      \
        }                                                                                                                                          \
                                                                                                                                                   \
        template class ClassName<Mode,                                                                                                             \
                                 ContainerTemplate<__VA_ARGS__, daal::internal::sve> DAAL_KERNEL_SVE_CONTAINER(ContainerTemplate, __VA_ARGS__)>;   \
        }
