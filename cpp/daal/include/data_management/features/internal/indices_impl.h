...
public:
    ...
    size_t size() const override { return _indices.size(); }

    bool isPlainRange() const override { return false; }

    bool areRawFeatureIndicesAvailable() const override { return true; }

    FeatureIndex getFirst() const override
    {
        if (!size())
        {
    ...
    FeatureIndex getLast() const override
    {
        if (!size())
        {
            return FeatureIndexTraits::invalid();
    ...
    services::BufferView<FeatureIndex> getRawFeatureIndices() override
    {
...
public:
    ...
    size_t size() const override { return services::internal::maxValue(_begin, _end) - services::internal::minValue(_begin, _end) + 1; }

    bool isPlainRange() const override { return true; }

    bool areRawFeatureIndicesAvailable() const override { return false; }

    FeatureIndex getFirst() const override { return _begin; }

    FeatureIndex getLast() const override { return _end; }

    services::BufferView<FeatureIndex> getRawFeatureIndices() override { return services::BufferView<FeatureIndex>(); }
