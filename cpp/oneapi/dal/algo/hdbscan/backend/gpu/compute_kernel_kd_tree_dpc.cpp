...
static result_t compute_kernel_kd_tree_impl(const context_gpu& ctx,
    ...
    for (std::int64_t b_start = 0; b_start < row_count; b_start += block_size) {
        ...
        std::cout << "[hdbscan-gpu][kd_tree] block #" << block_idx << " BEGIN alloc dist_block ("
        ...
        std::cout << "[hdbscan-gpu][kd_tree] block #" << block_idx << " END   alloc dist_block ok"
                  << std::endl;
        ...
        std::cout << "[hdbscan-gpu][kd_tree] block #" << block_idx << " END   alloc ksel_vals ok"
                  << std::endl;
        ...
        std::cout << "[hdbscan-gpu][kd_tree] block #" << block_idx << " END   kselect_by_rows ok"
                  << std::endl;
