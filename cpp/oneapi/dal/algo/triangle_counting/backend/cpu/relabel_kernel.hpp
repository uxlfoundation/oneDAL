...
void sort_ids_by_degree(const std::int32_t* degrees,
    ...
    dal::detail::threader_for(vertex_count, 1024, [&](std::int32_t n) {
    ...
    dal::detail::threader_for(vertex_count / 2, 1024, [&](std::int64_t i) {
...
void parallel_prefix_sum(const std::int32_t* degrees_relabel,
                         ...
                         std::int64_t vertex_count) {
    dal::detail::threader_for(num_blocks, 1, [&](std::int64_t block) {
...
void fill_relabeled_topology(const dal::preview::detail::topology<std::int32_t>& t,
    ...
    dal::detail::threader_for(vertex_count + 1, 4096, [&](std::int64_t n) {
        edge_offsets_relabel[n] = offsets[n];
    });

    dal::detail::threader_for(vertex_count, 1, [&](std::int64_t u) {
