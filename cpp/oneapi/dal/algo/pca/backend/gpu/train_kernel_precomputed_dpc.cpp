...
template struct train_kernel_gpu<float, method::precomputed, task::dim_reduction>;
template struct train_kernel_gpu<double, method::precomputed, task::dim_reduction>;
