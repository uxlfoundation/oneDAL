...
MSG(prev_partial_result_and_data_queues_mismatch,
    "Queue of the previous partial result does not match the queue of the data table");
MSG(weights_and_data_queues_mismatch, "Queues of weights and data tables do not match");
...
MSG(hdbscan_metric_not_compatible_with_kd_tree,
    "HDBSCAN cosine metric is not compatible with kd_tree and ball_tree methods")
