...
template array_impl<byte_t> ONEDAL_EXPORT chunked_array_base::flatten_impl(const default_host_policy&,
                                                             const host_allocator<byte_t>&) const;
template array_impl<const byte_t*> ONEDAL_EXPORT chunked_array_base::get_data_impl(
    const default_host_policy&,
    const host_allocator<const byte_t*>&) const;
template array_impl<byte_t*> ONEDAL_EXPORT chunked_array_base::get_mutable_data_impl(
    const default_host_policy&,
    const host_allocator<byte_t*>&) const;

#ifdef ONEDAL_DATA_PARALLEL
template array_impl<byte_t> ONEDAL_EXPORT chunked_array_base::flatten_impl(
