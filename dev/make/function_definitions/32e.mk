...
LINKERs = bfd gold lld llvm-lib
COMPILER ?= icx
CPUs := sse42 avx2 avx512
CPUs.files := neh hsw skx
OPTFLAG ?= O2
...
# sse42 to the start of the list of CPUs stored in 'var_name'
define add_mandatory_cpu
  $$(eval $1 := $$(if $$(filter sse42,$$($1)),$$($1),sse42 $$($1)))
endef
...
define set_arch_file_suffix
  $$(eval $1.files := $$(subst sse42,neh,$$(subst avx2,hsw,$$(subst avx512,skx,$$($1)))))
endef
...
define set_usecpu_defs
  $$(eval USECPUS.out.defs := $$(subst sse42,^\#define DAAL_KERNEL_SSE42$$(sed.eow),\
...
define add_cpu_to_uarch_in_files
  ...
  $$(eval user_cpu_files := $$(neh_files) $$(hsw_files) $$(skx_files))
endef
...
# This must be called after the mc3_OPT, avx2_OPT, skx_OPT, a8sve_OPT,
