...
define set_arch_file_suffix
  $$(eval $1.files := $$(subst sse2,nrh,$$(subst avx2,hsw,$$(subst avx512,skx,$$($1)))))
endef
...
define add_cpu_to_uarch_in_files
  ...
  $$(eval user_cpu_files := $$(nrh_files) $$(hsw_files) $$(skx_files))
endef
...
# This must be called after the p4_OPT, avx2_OPT, skx_OPT, a8sve_OPT,
