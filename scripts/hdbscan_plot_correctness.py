#!/usr/bin/env python3
"""
Plot HDBSCAN clustering results: oneDAL vs sklearn, highlighting agreements and mistakes.
Generates side-by-side comparison images for every dataset configuration.
"""
