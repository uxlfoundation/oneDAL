...
void run(sycl::queue &q) {
    const auto train_data_file_name = get_data_path("dev/data/kmeans_csr_train_data.csv");
    const auto initial_centroids_file_name =
        get_data_path("dev/data/kmeans_dense_train_centroids.csv");
    const auto test_data_file_name = get_data_path("dev/data/kmeans_csr_test_data.csv");
