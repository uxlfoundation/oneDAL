...
void run(sycl::queue& q) {
    ...
    const auto train_response_file_name = get_data_path("data/k_nearest_neighbors_train_label.csv");
    const auto test_data_file_name = get_data_path("data/k_nearest_neighbors_test_data.csv");
    const auto test_response_file_name = get_data_path("data/k_nearest_neighbors_test_label.csv");
