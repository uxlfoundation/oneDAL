...
void run(sycl::queue& q) {
    const auto x_train_filename = get_data_path("data/df_binary_classification_train_data.csv");
    const auto y_train_filename = get_data_path("data/df_binary_classification_train_label.csv");
    const auto x_test_filename = get_data_path("data/df_binary_classification_test_data.csv");
    const auto y_test_filename = get_data_path("data/df_binary_classification_test_label.csv");
