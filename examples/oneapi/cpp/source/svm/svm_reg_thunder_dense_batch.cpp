...
int main(int argc, char const *argv[]) {
    const auto train_data_file_name = get_data_path("data/svm_reg_train_dense_data.csv");
    const auto train_response_file_name = get_data_path("data/svm_reg_train_dense_label.csv");
    const auto test_data_file_name = get_data_path("data/svm_reg_test_dense_data.csv");
    const auto test_response_file_name = get_data_path("data/svm_reg_test_dense_label.csv");
