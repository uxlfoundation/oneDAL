...
const std::string traindatasetFileName = "dev/data/svm_multi_class_train_dense.csv";

const std::string testdatasetFileName = "dev/data/svm_multi_class_test_dense.csv";
