/* file: adaboost_samme_two_class_batch.cpp */
/*******************************************************************************
...
/**
 * <a name="DAAL-EXAMPLE-CPP-ADABOOST_SAMME_TWO_CLASS_BATCH"></a>
 * \example adaboost_samme_two_class_batch.cpp
 */
...
const std::string trainDatasetFileName = "adaboost_train.csv";
const std::string testDatasetFileName = "adaboost_test.csv";
...
void trainModel() {
    ...
    adaboost::training::Batch<> algorithm(nClasses);
...
void testModel() {
    ...
    adaboost::prediction::Batch<> algorithm(nClasses);
