...
/**
 * <a name="DAAL-EXAMPLE-CPP-DF_REG_HIST_DENSE_EXTRATREES_BATCH"></a>
 * \example df_reg_hist_dense_extratrees_batch.cpp
 */
...
const std::string traindatasetFileName = "dev/data/df_regression_train.csv";
const std::string testdatasetFileName = "dev/data/df_regression_test.csv";
