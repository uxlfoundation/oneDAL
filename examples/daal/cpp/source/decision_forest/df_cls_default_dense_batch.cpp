/* file: df_cls_default_dense_batch.cpp */
/*******************************************************************************
...
/**
 * <a name="DAAL-EXAMPLE-CPP-DF_CLS_DEFAULT_DENSE_BATCH"></a>
 * \example df_cls_default_dense_batch.cpp
 */
...
const std::string trainDatasetFileName = "df_classification_train.csv";
const std::string testDatasetFileName = "df_classification_test.csv";
