...
const std::string trainDatasetFileNames[4] = { "naivebayes_train_dense_1.csv",
                                               "naivebayes_train_dense_2.csv",
                                               "naivebayes_train_dense_3.csv",
                                               "naivebayes_train_dense_4.csv" };

const std::string testDatasetFileName = "naivebayes_test_dense.csv";
