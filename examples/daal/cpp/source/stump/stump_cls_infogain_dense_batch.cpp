/* file: stump_cls_infogain_dense_batch.cpp */
/*******************************************************************************
...
/**
 * <a name="DAAL-EXAMPLE-CPP-STUMP_CLS_INFOGAIN_DENSE_BATCH"></a>
 * \example stump_cls_infogain_dense_batch.cpp
 */
...
const std::string traindatasetFileName = "dev/data/stump_train.csv";
const std::string testdatasetFileName = "dev/data/stump_test.csv";
