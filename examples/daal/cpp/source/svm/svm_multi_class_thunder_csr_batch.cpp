...
const std::string traindatasetFileName = "dev/data/svm_multi_class_train_csr.csv";
const std::string trainLabelsFileName = "svm_multi_class_train_labels.csv";

const std::string testdatasetFileName = "dev/data/svm_multi_class_test_csr.csv";
