...
/**
 * <a name="DAAL-EXAMPLE-CPP-SVM_TWO_CLASS_BOSER_CSR_BATCH"></a>
 * \example svm_two_class_boser_csr_batch.cpp
 */
...
const std::string trainDatasetFileName = "svm_two_class_train_csr.csv";
const std::string trainLabelsFileName = "svm_two_class_train_labels.csv";

const std::string testDatasetFileName = "svm_two_class_test_csr.csv";
