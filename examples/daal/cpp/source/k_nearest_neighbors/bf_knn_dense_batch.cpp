...
const std::string traindatasetFileName = "dev/data/k_nearest_neighbors_train.csv";
const std::string testdatasetFileName = "dev/data/k_nearest_neighbors_test.csv";
