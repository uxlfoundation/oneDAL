/* file: lasso_reg_dense_batch.cpp */
/*******************************************************************************
...
/*
!  Content:
!    C++ example of multiple lasso regression in the batch processing mode.
!
!    The program trains the multiple lasso regression model on a training data
!    set with a QR decomposition-based method and computes regression for the
!    test data.
!******************************************************************************/

/**
 * <a name="DAAL-EXAMPLE-CPP-LASSO_REGRESSION_BATCH"></a>
 * \example lasso_reg_dense_batch.cpp
 */
...
void trainModel() {
    ...
    /* Create an algorithm object to train the multiple lasso regression model with a QR decomposition-based method */
    training::Batch<> algorithm;

    /* Pass a training data set and dependent values to the algorithm */
    algorithm.input.set(training::data, trainData);
    algorithm.input.set(training::dependentVariables, trainDependentVariables);
    algorithm.parameter().lassoParameters = NumericTablePtr(
        new HomogenNumericTable<>(nDependentVariables, 1, NumericTable::doAllocate, 0.01f));
...
void testModel() {
    ...
    /* Create an algorithm object to predict values of multiple lasso regression */
    ...
    /* Predict values of multiple lasso regression */
    algorithm.compute();
